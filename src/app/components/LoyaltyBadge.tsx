...
export function LoyaltyBadge({ tier, points, variant = "compact" }: LoyaltyBadgeProps) {
  ...
  const copy = {
    ru: { balance: "Баланс", status: "Ваш статус", points: "баллов", tiers: { bronze: "Bronze", silver: "Silver", gold: "Gold", platinum: "Platinum" } },
    kk: { balance: "Баланс", status: "Сіздің мәртебеңіз", points: "ұпай", tiers: { bronze: "Bronze", silver: "Silver", gold: "Gold", platinum: "Platinum" } },
    en: { balance: "Balance", status: "Your status", points: "points", tiers: { bronze: "Bronze", silver: "Silver", gold: "Gold", platinum: "Platinum" } },
  }[language];
  ...
  const tierConfig = {
    ...
    platinum: { label: copy.tiers.platinum, icon: Crown, gradient: "from-purple-100 to-pink-50", color: "text-purple-700", iconColor: "text-purple-600" },
  }[tier];
