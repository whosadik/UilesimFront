...
const helpPageCopy = {
  ru: {
    ...
    faq: [
      ...
      { id: 5, category: "loyalty", question: "Как работает программа лояльности?", answer: "За каждую покупку вы получаете баллы (5% от суммы заказа). Баллы можно использовать для оплаты следующих покупок. Чем больше покупаете, тем выше ваш уровень и больше привилегий." },
  ...
  kk: {
    ...
    faq: [
      ...
      { id: 5, category: "loyalty", question: "Лоялдылық бағдарламасы қалай жұмыс істейді?", answer: "Әр сатып алу үшін сіз ұпай аласыз (тапсырыс сомасының 5%-ы). Ұпайларды келесі сатып алуларды төлеуге пайдалануға болады. Көбірек сатып алған сайын деңгейіңіз жоғарылап, артықшылықтар көбейеді." },
  ...
  en: {
    ...
    faq: [
      ...
      { id: 5, category: "loyalty", question: "How does the loyalty program work?", answer: "You earn points for every purchase (5% of the order amount). Points can be used to pay for future purchases. The more you buy, the higher your level and the more benefits you get." },
